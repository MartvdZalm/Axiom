...
core::Result<semantic::SemanticModel>
Pipeline::analyze(const ast::TranslationUnit& unit, std::uint32_t buffer_id) {
...
core::Result<codegen::GeneratedUnit>
Pipeline::generate(const ast::TranslationUnit& unit, const semantic::SemanticModel& model) {
